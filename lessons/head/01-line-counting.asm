; 01-line-counting.asm - teaching implementation of a small `head` utility.
;
...
;
; Lesson limitations:
;   This initial layer intentionally accepts at most one pathname and has no count
;   options, byte mode, multi-file headers, EINTR retry, or full diagnostics.  See
;   ../../src/head.asm for the field-usable implementation.
;
; Teaching focus:
